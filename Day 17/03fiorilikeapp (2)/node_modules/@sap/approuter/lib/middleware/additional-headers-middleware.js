...
module.exports = function additionalHeaders(req, res, next) {
  ...
  routerConfig.additionalHeaders = modifyAdditionalHeadersFromResponseHeaders(req);
...
function modifyAdditionalHeadersFromResponseHeaders(req) {
  let foundIndex;
  let additionalHeaders = req.routerConfig.additionalHeaders;

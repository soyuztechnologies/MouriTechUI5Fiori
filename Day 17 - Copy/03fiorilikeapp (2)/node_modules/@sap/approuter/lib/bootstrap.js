...
var attachZoneInfo = require('./middleware/attach-zone-info');
var sapStatisticsMiddleware = require('./middleware/sap-statistics-middleware');
...
module.exports = function bootstrap(options) {
  ...
  var externalSessionStore = memstoreConfig.getExternalSessionStore(routerConfig.extSessionMgt);
  var sessionSecret = options.getSessionSecret ? options.getSessionSecret() : (cookieUtils.getExternalStoreSessionSecret(routerConfig.extSessionMgt) || cookieUtils.generateSessionSecret());
